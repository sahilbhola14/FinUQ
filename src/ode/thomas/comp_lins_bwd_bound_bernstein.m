function lins_bwd_bound = comp_lins_bwd_bound_bernstein(eval_num_intervals, precision, confidence_levels)
    ...
    for ii = 1:length(eval_num_intervals)
        ...
        gamma_one_critical = compute_probabilistic_gamma_n(1, precision, lambda_critical);
        gamma_two_critical = compute_probabilistic_gamma_n(2, precision, lambda_critical);
...
function gamma_n = compute_probabilistic_gamma_n(n, precision, lambda_vals)
