...
% Single Data
cdf_k_0_single = load('cdf_scalar_product_k_0_num_samples_1000000_space_single.mat');
cdf_k_6_single = load('cdf_scalar_product_k_6_num_samples_1000000_space_single.mat');


% Half Data
cdf_k_0_half = load('cdf_scalar_product_k_0_num_samples_1000000_space_half.mat');
cdf_k_6_half = load('cdf_scalar_product_k_6_num_samples_1000000_space_half.mat');
...
axes(ha(2)); 
    ...
    grid on
    box on
    xlabel("$\xi_{\times} = \vert \delta_{\times}\vert$", "Interpreter", "latex", "FontSize", 20);
    ylabel("$F_{\Xi_{\times}}(\xi_{\times})$", "Interpreter", "latex", "FontSize", 20);
...
axes(ha(1)); 
    ...
    set(gca, "FontSize", 20, "TickLabelInterpreter", "latex", "LineWidth", 1.75);
hold off
saveas(gcf,"cdf_scalar_product.png")
