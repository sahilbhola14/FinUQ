"""
Contour plot of Poisson equation solution from Jacobi CSV output.
...
parser = argparse.ArgumentParser(description="Poisson Jacobi solution contour plot")
parser.add_argument(
    "--prec",
...
def plot_contour(path: str, ax: plt.Axes) -> None:
    ...
    ax.set_title(
        rf"Poisson Jacobi solution  |  {prec_str}  |  $\zeta={zeta_str}$",
        fontsize=14,
    )
...
def main() -> None:
    ...
    savename = f"poisson_jacobi_contour_{args.prec}_prec.png"
